...
import NewspaperIcon from "assets/svg/icons/NewspaperIcon";
                            ...
                            <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white">
                                ...
                                >
                                    <div className="absolute top-0 right-0 -mr-12 pt-2">
                                        <button
                                            type="button"
                                            className="ml-1 flex h-10 w-10 items-center justify-center rounded-full focus-outline focus:ring-white transition-all"
                                                    ...
                                                    <li key={index}>
                                                        <Link
                                                            ...
                                                            className={classNames(
                                                                ...
                                                                "group flex items-center px-2 py-2 text-lg font-medium rounded-md focus-outline focus:ring-blue-500 transition-all"
                                                            )}
                                                            onClick={() =>
                                                                setIsOpen(false)
                                                            }
                                                        >
                                                            <link.icon
                                                                className={classNames(
                                                                    ...
                                                                    "mr-4 flex-shrink-0 h-8 w-8 transition-all"
                                                                )}
                                                                aria-hidden="true"
                                                            />
                                                            {link.name}
