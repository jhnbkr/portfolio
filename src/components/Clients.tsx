                            ...
                            return (
                                <li key={index} className="col-span-1 flex">
                                    ...
                                    >
                                        ...
                                        <client.logo
                                            className="aspect-[3/2] text-slate-600 md:group-hover:text-teal-500 md:group-hover:scale-110 md:group-focus:text-teal-500 md:group-focus:scale-110 motion-safe:transition-all"
                                            aria-hidden="true"
                                        />
                                    </Link>
                                </li>
