            ...
            <div className="bg-slate-100 border-b border-gray-200">
                <div className="flex flex-col items-center justify-center mx-auto md:max-w-5xl px-6 py-10 md:px-8 md:py-16 space-y-6 md:space-y-8">
                    ...
                    <Link
                        ...
                        scroll={false}
                        className="inline-flex items-center bg-slate-500 hover:bg-slate-600 rounded-full border-none px-6 py-2 text-white text-xl font-medium shadow-lg hover:cursor-pointer focus-outline focus:ring-blue-500 motion-safe:transition-all"
                    >
                        Contact Me
                        <EnvelopeIcon
