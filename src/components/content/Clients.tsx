...
import PlayStationLogo from "assets/svg/logos/PlayStationLogo";
...
const Clients = forwardRef<HTMLElement>((props, ref) => {
    ...
    return (
        <section ref={ref} id="clients" data-location="clients">
                        ...
                        return (
                            <li key={index} className="col-span-1 flex">
                                <Link
                                    ...
                                    className="group flex flex-grow justify-center p-4 w-60 h-40 rounded focus-outline focus:outline-blue-500 transition-all"
                                >
                                    <span className="sr-only">
                                        {client.name}
                                    </span>
                                    <client.logo
                                        className="aspect-[3/2] text-slate-600 group-hover:text-slate-700 group-hover:scale-110 transition-all"
                                        aria-hidden="true"
                                    />
                                </Link>
                            </li>
